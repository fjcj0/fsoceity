...
export const posts = [
  {
    ...
    paragraph:
      "Enjoying the latest tech innovations at work! Excited about new AI tools 🤖.",
    likesNumber: 42,
    isLiked: true,
    isBookMarked: true,
  },
  {
    ...
    paragraph:
      "Just tried this awesome gadget — tech life is the best life! 💻✨",
    likesNumber: 88,
    isLiked: false,
    isBookMarked: false,
  },
...
export const dummyGroups = [
  ...
  },
  {
    name: "Movie Fans",
    groupPicture:
      "https://images.unsplash.com/photo-1524985069026-dd778a71c7b4?auto=format&fit=crop&w=80&q=80",
    isJoined: false,
    isPending: false,
    isCreated: true,
